...
`SIS_MENU_FED.sql` registra el módulo en el modelo normalizado: `OSS_MOD` código 9 (`FED`) y las opciones 9000 padre, 9010 Emisores, 9020 Números de Control, con `MERGE` reejecutable.
